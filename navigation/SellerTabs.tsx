    ...
    <Tab.Navigator
      ...
      screenOptions={({ route }) => ({
        tabBarIcon: ({ color, size }) => {
          ...
          if (route.name === 'ProfileSeller') {
            iconName = 'account';
          } else if (route.name === 'ManageStock') {
            iconName = 'cube-outline';
          } else if (route.name === 'OrdersSeller') {
            iconName = 'cart-outline';
          } else if (route.name === 'EditBoutiqueInfo') {
            iconName = 'store-edit-outline';
          } else if (route.name === 'SellerStats') {
            iconName = 'chart-line';
          }
